...
{
  public class Gbxmodel : IBlock
  {
    public GbxmodelBlock GbxmodelValues = new GbxmodelBlock();
    public void Read(BinaryReader reader)
    {
      Trace.WriteLine("Loading 'Gbxmodel'------------------------------------------------------");
...
public class GbxmodelRegionBlockCollection : System.Collections.CollectionBase
{
  private Block linkedBlock;
  public GbxmodelRegionBlockCollection(Block linkedBlock)
  {
    this.linkedBlock = linkedBlock;
  }
  public void Add(GbxmodelRegionBlock block)
  {
    InnerList.Add(block);
    if (linkedBlock.Count < InnerList.Count) linkedBlock.Count = InnerList.Count;
  }
  ...
  public GbxmodelRegionBlock this[int index]
  {
    get { return (InnerList[index] as GbxmodelRegionBlock); }
  }
}
private GbxmodelRegionBlockCollection _regionsCollection;
public GbxmodelRegionBlockCollection Regions
{
  get { return _regionsCollection; }
}
public class GbxmodelGeometryBlockCollection : System.Collections.CollectionBase
{
  private Block linkedBlock;
  public GbxmodelGeometryBlockCollection(Block linkedBlock)
  {
    this.linkedBlock = linkedBlock;
  }
  public void Add(GbxmodelGeometryBlock block)
  {
    InnerList.Add(block);
    if (linkedBlock.Count < InnerList.Count) linkedBlock.Count = InnerList.Count;
  }
  ...
  public GbxmodelGeometryBlock this[int index]
  {
    get { return (InnerList[index] as GbxmodelGeometryBlock); }
  }
}
private GbxmodelGeometryBlockCollection _geometriesCollection;
public GbxmodelGeometryBlockCollection Geometries
{
...
_regionsCollection = new GbxmodelRegionBlockCollection(_regions);
_geometriesCollection = new GbxmodelGeometryBlockCollection(_geometries);
...
public class GbxmodelRegionPermutationBlockCollection : System.Collections.CollectionBase
{
  private Block linkedBlock;
  public GbxmodelRegionPermutationBlockCollection(Block linkedBlock)
  {
    this.linkedBlock = linkedBlock;
  }
  public void Add(GbxmodelRegionPermutationBlock block)
  {
    InnerList.Add(block);
    if (linkedBlock.Count < InnerList.Count) linkedBlock.Count = InnerList.Count;
  }
  public void AddNew()
  {
    Add(new GbxmodelRegionPermutationBlock());
  }
  public void Remove(int index)
  {
    InnerList.RemoveAt(index);
  ...
  public GbxmodelRegionPermutationBlock this[int index]
  {
    get { return (InnerList[index] as GbxmodelRegionPermutationBlock); }
  }
}
private GbxmodelRegionPermutationBlockCollection _permutationsCollection;
public GbxmodelRegionPermutationBlockCollection Permutations
{
...
_permutationsCollection = new GbxmodelRegionPermutationBlockCollection(_permutations);
...
public class GbxmodelGeometryPartBlockCollection : System.Collections.CollectionBase
{
  private Block linkedBlock;
  public GbxmodelGeometryPartBlockCollection(Block linkedBlock)
  {
    this.linkedBlock = linkedBlock;
  }
  public void Add(GbxmodelGeometryPartBlock block)
  {
    InnerList.Add(block);
    if (linkedBlock.Count < InnerList.Count) linkedBlock.Count = InnerList.Count;
  }
  public void AddNew()
  {
    Add(new GbxmodelGeometryPartBlock());
  }
  public void Remove(int index)
  {
    InnerList.RemoveAt(index);
  ...
  public GbxmodelGeometryPartBlock this[int index]
  {
    get { return (InnerList[index] as GbxmodelGeometryPartBlock); }
  }
}
private GbxmodelGeometryPartBlockCollection _partsCollection;
public GbxmodelGeometryPartBlockCollection Parts
{
...
_flags = new Flags(4);
__unnamed = new Pad(32);
_partsCollection = new GbxmodelGeometryPartBlockCollection(_parts);
...
__unnamed2 = new Pad(16);
__unnamed3 = new Pad(1);
__unnamed4 = new Pad(1);
__unnamed5 = new Pad(1);
