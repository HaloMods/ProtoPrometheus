...
{
	public class RealQuaternion : Field
	{
		...
		private DevExpress.XtraEditors.TextEdit txtW;
		private DevExpress.XtraEditors.TextEdit txtK;

		private Types.RealQuaternion value;

		public Types.RealQuaternion Value
		{
		...
		{
			if (!(value is Types.RealQuaternion))
				throw new Exception("Cannot bind " + value.ToString() + " to RealQuaternion control.");

			this.value = (value as Types.RealQuaternion);
			...
			this.txtW.DataBindings.Clear();
			this.txtW.DataBindings.Add(new Binding("Text", this.value, "W"));
		}
		...
		private void InitializeComponent()
		{
			...
			this.txtW = new DevExpress.XtraEditors.TextEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtW.Properties)).BeginInit();
			...
			// txtI.Properties
			// 
			this.txtI.Properties.Appearance.ForeColor = System.Drawing.Color.White;
			this.txtI.Properties.Appearance.Options.UseForeColor = true;
			...
			this.lblName.Text = "Real Quaternion";
			...
			// 
			this.txtW.EditValue = "";
			this.txtW.Location = new System.Drawing.Point(352, 4);
			this.txtW.Name = "txtW";
			this.txtW.Size = new System.Drawing.Size(44, 20);
			...
			((System.ComponentModel.ISupportInitialize)(this.txtW.Properties)).EndInit();
