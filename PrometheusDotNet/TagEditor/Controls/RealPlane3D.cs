...
{
	public class RealPlane3D : Field
	{
		...
		private Types.RealPlane3D value;

		public Types.RealPlane3D Value
		{
		...
		{
			if (!(value is Types.RealPlane3D))
				throw new Exception("Cannot bind " + value.ToString() + " to RealPlane3D control.");

			this.value = (value as Types.RealPlane3D);
		...
		private void InitializeComponent()
		{
			...
			// 
			this.txtD.EditValue = "";
			this.txtD.Location = new System.Drawing.Point(352, 4);
			this.txtD.Name = "txtD";
