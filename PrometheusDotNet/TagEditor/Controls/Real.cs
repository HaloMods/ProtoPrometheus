...
{
	public class Real : Field
	{
    private TextEdit txtValue;
    private AutoSizeLabel lblName;
		private IContainer components = null;

    private Types.Real value;

    public Types.Real Value
    {
    ...
    {
      if (!(value is Types.Real))
        throw new Exception("Cannot bind " + value.ToString() + " to Real control.");

      this.value = (Types.Real)value;
