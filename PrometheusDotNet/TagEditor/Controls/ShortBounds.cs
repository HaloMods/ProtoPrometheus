...
{
	public class ShortBounds : Field
	{
		...
		private Types.ShortBounds value;

		public Types.ShortBounds Value
		{
		...
		{
			if (!(value is Types.ShortBounds))
				throw new Exception("Cannot bind " + value.ToString() + " to ShortBounds control.");

			this.value = (value as Types.ShortBounds);
