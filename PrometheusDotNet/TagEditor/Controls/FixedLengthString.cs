...
{
	public class FixedLengthString : Field
	{
    private DevExpress.XtraEditors.TextEdit txtValue;
    private AutoSizeLabel lblName;
		private System.ComponentModel.IContainer components = null;

    private Types.FixedLengthString value;

    public Types.FixedLengthString Value
    {
      ...
      set { this.value = value; }
		...
		public FixedLengthString()
		{
			...
			InitializeComponent();
      this.lblName.AutoSizeHeight = true;
		}
    ...
    {
      if (!(value is Types.FixedLengthString))
        throw new Exception("Cannot bind " + value.ToString() + " to FixedLengthString control.");

      this.value = (value as Types.FixedLengthString);
