...
//    private const int IMAGE_INDEX_INFORMATION = 3;
    ...
    private SimpleButton _defaultButtonControl = null;
...
//    private int _maxLayoutHeight;
    ...
    private CheckEdit chbSaveResponse;
    ...
    private void InitializeComponent()
    {
      ...
      this.chbSaveResponse = new DevExpress.XtraEditors.CheckEdit();
      ((System.ComponentModel.ISupportInitialize)(this.chbSaveResponse.Properties)).BeginInit();
      this.SuspendLayout();
      // 
      // panelIcon
      // 
      ...
      this.rtbMessage.Text = "oihgokgkjgkjgkjhg";
      ...
      // 
      // chbSaveResponse.Properties
      // 
      this.chbSaveResponse.Properties.Caption = "";
      this.chbSaveResponse.Size = new System.Drawing.Size(104, 18);
      ...
      ((System.ComponentModel.ISupportInitialize)(this.chbSaveResponse.Properties)).EndInit();
...
//      int ncHeight = this.Height - this.ClientSize.Height;	
      ...
      int saveResponseRowWidth = chbSaveResponse.Width + (panelIcon.Width / 2);
    ...
    private void LayoutControls()
    {
      ...
      chbSaveResponse.Location = new Point(LEFT_PADDING + (panelIcon.Width / 2), 
        TOP_PADDING + Math.Max(panelIcon.Height, rtbMessage.Height) + ITEM_PADDING);
				
      Size buttonSize = GetButtonSize();
      int allButtonsWidth = GetWidthOfAllButtons();

      int firstButtonX = ((this.ClientSize.Width - allButtonsWidth) / 2);
      ...
      foreach(MessageBoxExButton button in _buttons)
      {
        ...
        SimpleButton buttonCtrl = GetButton(button, buttonSize, nextButtonLocation);
